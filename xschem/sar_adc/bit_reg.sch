...
C {xschem/sar_adc/async_nand2.sym} -120 -140 0 0 {name=x1}
C {xschem/sar_adc/async_inverter.sym} 210 -150 0 0 {name=x3}
C {xschem/sar_adc/dff_cell.sym} 540 -150 0 0 {name=x4}
