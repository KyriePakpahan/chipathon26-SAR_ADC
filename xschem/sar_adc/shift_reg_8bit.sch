...
C {xschem/sar_adc/dff_cell.sym} -1340 0 0 0 {name=x1}
...
C {xschem/sar_adc/dff_cell.sym} -940 0 0 0 {name=x2}
...
C {xschem/sar_adc/dff_cell.sym} -520 0 0 0 {name=x3}
...
C {xschem/sar_adc/dff_cell.sym} -120 0 0 0 {name=x4}
...
C {xschem/sar_adc/dff_cell.sym} 290 0 0 0 {name=x5}
...
C {xschem/sar_adc/dff_cell.sym} 690 0 0 0 {name=x6}
...
C {xschem/sar_adc/dff_cell.sym} 1090 0 0 0 {name=x7}
...
C {xschem/sar_adc/dff_cell.sym} 1500 0 0 0 {name=x8}
...
C {xschem/sar_adc/dff_cell.sym} 1900 0 0 0 {name=x9}
