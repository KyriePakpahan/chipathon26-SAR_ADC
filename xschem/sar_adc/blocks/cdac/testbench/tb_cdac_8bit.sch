...
C {lab_wire.sym} 40 -380 0 0 {name=l2 lab=VSS}
C {lab_wire.sym} 500 -380 0 0 {name=l3 lab=VSS}
C {lab_pin.sym} 500 -480 1 0 {name=p1 sig_type=std_logic lab=vdd}
C {lab_pin.sym} 40 -480 1 0 {name=p2 sig_type=std_logic lab=vref}
C {lab_wire.sym} 290 -440 0 0 {name=l4 lab=VSS}
C {res.sym} 420 -380 0 0 {name=R1
value=1G
footprint=1206
device=resistor
m=1}
C {lab_wire.sym} 420 -350 0 0 {name=l5 lab=VSS}
...
C {lab_wire.sym} 240 -190 0 0 {name=l6 lab=VSS}
