...
C {lab_wire.sym} -400 0 0 0 {name=l_vss lab=vss}
C {lab_wire.sym} -400 80 0 0 {name=l_gnd3 lab=0}
C {vsource.sym} -400 160 0 0 {name=V_D7 value="PULSE(0 3.3 0 1n 1n 2u 4u)"}
C {lab_wire.sym} -400 120 0 0 {name=l_vd7 lab=dac_in[7]}
C {lab_wire.sym} -400 200 0 0 {name=l_gnd4 lab=0}
C {vsource.sym} -400 280 0 0 {name=V_D6 value=0}
C {lab_wire.sym} -400 240 0 0 {name=l_vd6 lab=dac_in[6]}
C {lab_wire.sym} -400 320 0 0 {name=l_gnd_d6 lab=0}
C {vsource.sym} -400 380 0 0 {name=V_D5 value=0}
C {lab_wire.sym} -400 340 0 0 {name=l_vd5 lab=dac_in[5]}
C {lab_wire.sym} -400 420 0 0 {name=l_gnd_d5 lab=0}
C {vsource.sym} -400 480 0 0 {name=V_D4 value=0}
C {lab_wire.sym} -400 440 0 0 {name=l_vd4 lab=dac_in[4]}
C {lab_wire.sym} -400 520 0 0 {name=l_gnd_d4 lab=0}
C {vsource.sym} -400 580 0 0 {name=V_D3 value=0}
C {lab_wire.sym} -400 540 0 0 {name=l_vd3 lab=dac_in[3]}
C {lab_wire.sym} -400 620 0 0 {name=l_gnd_d3 lab=0}
C {vsource.sym} -400 680 0 0 {name=V_D2 value=0}
C {lab_wire.sym} -400 640 0 0 {name=l_vd2 lab=dac_in[2]}
C {lab_wire.sym} -400 720 0 0 {name=l_gnd_d2 lab=0}
C {vsource.sym} -400 780 0 0 {name=V_D1 value=0}
C {lab_wire.sym} -400 740 0 0 {name=l_vd1 lab=dac_in[1]}
C {lab_wire.sym} -400 820 0 0 {name=l_gnd_d1 lab=0}
C {vsource.sym} -400 880 0 0 {name=V_D0 value=0}
C {lab_wire.sym} -400 840 0 0 {name=l_vd0 lab=dac_in[0]}
C {lab_wire.sym} -400 920 0 0 {name=l_gnd_d0 lab=0}
...
C {lab_wire.sym} 350 -140 2 0 {name=l_rl_p lab=vdac}
C {lab_wire.sym} 350 -60 0 0 {name=l_rl_m lab=0}
