...
C {lab_wire.sym} -350 -200 0 0 {name=l_bit lab=bit}
...
# VREF Switch to BOT (active when bit=1, i.e., bit_b=0 and bit=1)
...
# VSS Switch to BOT (active when bit=0, i.e., bit=0 and bit_b=1)
